...
if (empty($_SERVER['HTTP_HOST'])) {
  $_SERVER['HTTP_HOST'] = 'recemos-juntos.lndo.site';
}
...
// Shows SQL Query on views admin page.
$config['views.settings']['ui']['show']['sql_query']['enabled'] = TRUE;
// Skip config ignore module
$settings['config_ignore_deactivate'] = TRUE;


$settings['trusted_host_patterns'] = [
  '^recemos-juntos\.lndo\.site$',
  '^localhost$',
  '^127.0.0.1$',
];

$settings['config_sync_directory'] = 'sites/default/config_6nAJfR50OUHPJ3i2S_3vcZ9Bb6NtXcPjMK2g7ppOwXxd2lglT7n6DzKMRd-DpnV_2bUg8a3Y0A/sync';
